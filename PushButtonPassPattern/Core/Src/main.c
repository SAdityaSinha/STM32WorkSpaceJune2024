...
#define UsingHeaderFile
#undef UsingHeaderFile    //will be affectievly used in the condition of 

#define UsingMyHeader
// #undef UsingMyHeader     //if undef then else part will execure
